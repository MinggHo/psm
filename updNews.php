...
if(isset($_SESSION['MM_Username']))
{
	$sql = mysql_query("Select a.date , a.news , a.subject from news a where a.news_id=a.news_id and  a.news_id = '{$_GET['news_id']}'");
	$row = mysql_fetch_object($sql);
}
if(isset($_POST['submit']))
{
	 $sqlnophoto = "UPDATE news SET
			date ='{$_POST['date']}', 
			news ='{$_POST['news']}',
			...
			WHERE news_id = '{$news_id}'";
				...
				if ($res)
				{
				echo "<script type='text/javascript'>alert('Sucessfully update.');window.location='manage.php';</script>";			
				}
				else {
						...
						<div class="panel panel-widget">
							<div class="panel-title">
							  ...
							  <form method="post" action="" enctype="multipart/form-data" class="valida" autocomplete="off" novalidate="novalidate">
								...
								<label for="field-4"><font color="black">New Event</font><span class="at-required-highlight"></span></label>
								<br>
								<div class = "col-sm-6" class="form-group">
									<label col-sm-6><font color="black">Date :</font><input type="date" value="<?php echo $row->date; ?>" name="date"></input></label><br>
									<label col-sm-6><font color="black">Subject :</font><input placeholder="Subject :" type="text" value="<?php echo $row->subject; ?>" name="subject" id="field-4"  class="form-control" style="width: 400px ; height: 50px"></input></label><br>
									<label col-sm-6><font color="black">News :</font><input placeholder="Write your news here :"  value="<?php echo $row->news; ?>" name="news" id="field-4"  class="form-control" rows="10" style="width: 800px ; height: 100px"></input></label>
