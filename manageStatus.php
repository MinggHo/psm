							...
							<div class="panel-title">
							 ...
							 <table border ="1px" width="100%">
								        ...
								        <?php
								            ...
								            {
								            Print "<tr>";
								              Print '<td align="center">'. $row['stat_id']. "</td>";
								              Print '<td align="center">'. $row['day']. "</td>";
								              Print '<td align="center">'. $row['date']. "</td>";
								              Print '<td align="center">'. $row['status']. "</td>";
								              Print '<td align="center"><a href="#!" onclick="myFunction_1('.$row['stat_id'].')">Update</a></td>';
								              Print '<td align="center"><a href="#!" onclick="myFunction_2('.$row['stat_id'].')">Delete</a></td>';
								            Print "</tr>";
								            }
								        ?>
								    	</table>
								    	...
								    	<script>
								    		...
								    		function myFunction_2(id)
								    		{
								    			...
								    			if (r=true)
								    			{
								    				location.href="delStatus.php?stat_id=" + id;
								    			}
								    		}
								    	</script>
							</div>
