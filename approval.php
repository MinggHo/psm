...
if(isset($_GET['book_id'])){
	$sql = "Select * from booking where book_id ='{$_GET['book_id']}'";
	$result = mysql_query($sql);
	$row = mysql_fetch_assoc($result);
}
if(isset($_POST['update']))
{
	$sqlnophoto = "UPDATE booking SET
			status = '{$_POST['status']}'
					...
					<div class="monthly-grid">
						<div class="panel panel-widget">
							<div class="panel-title">
							  ...
							  <br>
								<div class="bs-example4" data-example-id="contextual-table"><form method="POST" name="form2" id="form2" action=""  enctype="multipart/form-data">
						<table class="table">
						  <thead>
							<tr>
							  <th>Subject</th>
						  ...
						  <tbody>
							...
							<th><?php echo $row['date'] ?>|| <?php echo $row['time'] ?></th>
