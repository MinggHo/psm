...
if(isset($_POST['submit'])){	 
			...
			$sql = mysql_query("insert into student(username, password, name, dob, gender, phone, course_sect) 
			values('{$_POST['username']}','{$_POST['password']}', '{$_POST['name']}', '{$_POST['dob']}', '{$_POST['gender']}', '{$_POST['phone']}', '{$_POST['course_sect']}')");
			if($sql)
			{
				echo "<script type='text/javascript'>alert('Sucessfully insert.');window.location='register_student.php';</script>";
			}
			else
			{
								...
								<div class="contain">	
								 ...
								 <!-- Form -->
									<form action="" method="POST" enctype="multipart/form-data">
										...
										<div>
											<label>
												<input placeholder="Username :" name="username" type="text" tabindex="2" required="" autofocus="">
											</label>
										</div>
										<div>
											<label>
										...
										<div>
											<label class="col-sm-2 control-label"><font color="black">Date Of Birth :</font></label>
												<div class="col-sm-4">
										...
										<div>
											<label>
												<input placeholder="Course / Section :" type="text" name="course_sect" tabindex="3" >
											</label>
										</div>
										<div>
											<label>
												<input placeholder="Phone Number :" type="text"  name="phone" tabindex="3" >
											</label>
										</div>
										<div class="sky-form">
											<div class="sky_form1">
