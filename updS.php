...
if(isset($_SESSION['MM_Username']))
{
	$sql = mysql_query("SELECT stud_id, name , password , dob , course_sect ,phone from student where  stud_id = '$stud_id'");
	$row = mysql_fetch_object($sql);
    //$stud_id = $row['stud_id'];
}
if(isset($_POST['submit']))
{
	  $sqlnophoto = "UPDATE student SET
			name ='{$_POST['name']}', 
			password ='{$_POST['password']}',
			dob ='{$_POST['dob']}',
			course_sect = '{$_POST['course_sect']}',
			phone = '{$_POST['phone']}'
			WHERE stud_id = '$stud_id'";
				$res = mysql_query($sqlnophoto);
				if ($res)
				{
				echo "<script type='text/javascript'>alert('Sucessfully update.');window.location='viewS.php';</script>";			
				}
				else {
							  ...
							  <div class="registration_form">
								 <!-- Form -->
									<form action="" enctype="multipart/form-data" method="POST">
										<div>
											<label col-sm-6><font color="black">Name :</font>
												<input placeholder="Name :" type="text" name="name" value="<?php echo $row->name; ?>" tabindex="4" required="" style="width: 500px ; height: 40px">
											</label>
										</div>
										<div>
											<label col-sm-6><font color="black">Password :</font>
												<input placeholder="Password :" type="text" name="password" value="<?php echo $row->password; ?>" tabindex="4" required="" style="width: 300px ; height: 40px">
											</label>
										</div>						
										<div>
											<label col-sm-6><font color="black">Date of Birth :</font>
												<input placeholder="Date Of Birth :"value="<?php echo $row->dob; ?>" name="dob" type="date" tabindex="4" style="width: 400px ; height: 40px">
											</label>
										</div>	
										<div>
											<label col-sm-6><font color="black">Course / Section :</font>
												<input placeholder="Course / Section:"value="<?php echo $row->course_sect; ?>" type="text" name="course_sect" tabindex="3" style="width: 300px ; height: 40px">
											</label>
										</div>
										<div>
											<label col-sm-6><font color="black">Phone Number :</font>
												<input placeholder="Phone Number :"value="<?php echo $row->phone; ?>" name="phone" type="text" tabindex="3"  style="width: 300px ; height: 40px">
											</label>
										</div>
										<div>
