...
if(isset($_POST['sub-1'])){	
			...
			$sql = mysql_query("insert into news(news, subject , date) 
			values('{$_POST['news']}','{$_POST['subject']}','{$_POST['date']}')");
			if($sql)
			{
				echo "<script type='text/javascript'>alert('Sucessfully insert.');window.location='manage.php';</script>";
			}
			else
			{
							...
							<div class="panel-title">
							  ...
							  <form method="post" action="" enctype="multipart/form-data" class="valida" autocomplete="off" novalidate="novalidate">
										...
										<div class = "col-sm-6" class="form-group">
											<label col-sm-6><font color="black">Date :</font><input type="date" name="date"></input></label><br>
											<label col-sm-6><font color="black">Subject :</font><input placeholder="Subject :" type="text" name="subject" id="field-4"  class="form-control" style="width: 500px ; height: 50px"></input></label><br>
											<label col-sm-6><font color="black">News :</font><input placeholder="Write your news here :"  name="news" id="field-4" required="true" class="form-control" rows="10" style="width: 800px ; height: 100px"></input></label>
