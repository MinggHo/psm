...
$stud_id=$_GET['stat_id'];
if(isset($_SESSION['MM_Username']))
{
	 $sql = mysql_query("SELECT *  from status where  stat_id = '$stud_id'");
	$row = mysql_fetch_object($sql);
   // echo  $row->lect_id;;
}
if(isset($_POST['submit']))
{	  $sqlnophoto = "UPDATE status SET
			date ='{$_POST['date']}', 
			day ='{$_POST['day']}',
			status ='{$_POST['status']}'
			WHERE stat_id = '{$_POST['stat_id']}'";
				...
				if ($res)
				{
				echo "<script type='text/javascript'>alert('Sucessfully update.');window.location='manageStatus.php';</script>";			
				}
				else {
							...
							<div class="panel-title">
							  ...
							  <form method="post" action="" enctype="multipart/form-data" class="valida" autocomplete="off" novalidate="novalidate">
										...
										<div class = "col-sm-6" class="form-group">
											<label col-sm-6><font color="black">Date of Changes:</font><input value="<?php echo $row->date; ?>" type="date" name="date"></label><br>
											<input value="<?php echo $row->day; ?>" placeholder="Day :" type="text" name="day"><br><br>
											<input value="<?php echo $row->status; ?>" placeholder="Write your status here :"  name="status" id="field-4" required="true" class="form-control" rows="10" width="400px" height="200px"></input>
											<input value="<?php echo $row->stat_id; ?>"  type="hidden" name="stat_id"><br><br>
										<br>
										<p>
