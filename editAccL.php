...
if(isset($_SESSION['MM_Username']))
{
	$sql = mysql_query("Select * from lecturer where username ='{$username}'");
...
if(isset($_POST['submit']))
{
	$sqlnophoto = "UPDATE lecturer SET 
			...
			phone = '{$_POST['phone']}'
				...
				if ($res)
				{
				echo "<script type='text/javascript'>alert('Sucessfully update.');window.location='viewAccountL.php';</script>";			
				}
				else {
