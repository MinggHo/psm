...
<?php
	...
	$sql = "Select * from booking join student on student.username = booking.username where student.username = '".$_SESSION['MM_Username']."'";
					...
					<div class="monthly-grid">
						<div class="panel panel-widget">
							<div class="panel-title">
							  Student Page - View Booking Status !
