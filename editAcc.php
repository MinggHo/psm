...
if(isset($_SESSION['MM_Username']))
{
	$sql = mysql_query("Select * from student where username ='{$username}'");
...
if(isset($_POST['submit']))
{
	$sqlnophoto = "UPDATE student SET
			...
			phone = '{$_POST['phone']}'
				...
				if ($res)
				{
				echo "<script type='text/javascript'>alert('Sucessfully update.');window.location='viewAccountS.php';</script>";			
				}
				else {
			...
			<!-- top_bg -->
				...
				<div class="header_bg">
							...
							<div class="header">
								<div class="head-t">
									<div class="logo">
										<a href="index.php"><img src="images/ftmk-logo.png" class="img-responsive" alt=""> </a>
									</div>
								<div class="clearfix"> </div>
							</div>
						</div>
						...
						<div class="panel panel-widget">
							<div class="panel-title">
							  ...
							  <div class="registration">
								...
								<h4>Editing Your Account ? <span> Make the changes below </span></h4>
								<!-- [if IE] 
								...
								<script>
								 ...
								 <!-- Form -->
									<form action="" enctype="multipart/form-data" method="POST">
										...
										<div>
											<label>
												<input placeholder="Course / Section:"value="<?php echo $row->course_sect; ?>" type="text" name="course_sect" tabindex="3" >
											</label>
										</div>
										<div>
											<label>
