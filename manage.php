							...
							<div class="panel-title">
							 ...
							 <table border ="1px" >
								        ...
								        <?php
								            ...
								            $query = mysql_query ("Select news_id , subject , date , news from news");
								            while($row = mysql_fetch_array($query))
								            {
								            Print "<tr>";
								              Print '<td align="center">'. $row['news_id']. "</td>";
								              Print '<td align="center">'. $row['subject']. "</td>";
								              Print '<td align="center">'. $row['date']. "</td>";
								              Print '<td align="center">'. $row['news']. "</td>";
								              Print '<td align="center"><a href="#!" onclick="myFunction_1('.$row['news_id'].')">Update</a></td>';
								              Print '<td align="center"><a href="#!" onclick="myFunction_2('.$row['news_id'].')">Delete</a></td>';
								            Print "</tr>";
								            }
								        ?>
								    	</table>
								    	...
								    	<script>
								    		...
								    		{
								    			var r=confirm("Updating the news ?");
								    			if (r=true)
								    			{
								    				location.href="updNews.php?news_id=" + id;
								    			}
								    		}
								    		...
								    		function myFunction_2(id)
								    		{
								    			...
								    			if (r=true)
								    			{
								    				location.href="delN.php?news_id=" + id;
								    			}
								    		}
								    	</script>
							</div>
