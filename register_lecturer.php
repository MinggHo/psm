...
if(($_FILES['file']['type'] = 'image/gif') 
	...
	&& ($_FILES['file']['size'] < 2000000))
	{
		...
		else if (move_uploaded_file($_FILES['file']['tmp_name'],'upload/'.$_FILES['file']['name']))
		{
			...
			$sql = mysql_query("insert into lecturer(username, password, name, dob, gender, phone, department, timetable) 
			values('{$_POST['username']}','{$_POST['password']}', '{$_POST['name']}', '{$_POST['dob']}', '{$_POST['gender']}', '{$_POST['phone']}', '{$_POST['department']}', '{$part}')");
			if($sql)
			{
				echo "<script type='text/javascript'>alert('Sucessfully insert.');window.location='register_lecturer.php';</script>";
			}
			else
			{
			...
			<div class="content">
					<div class="monthly-grid">
						<div class="panel panel-widget">
							...
							<div class="registration_left">
							<!--nanti nak tambah apa apa info on the left tulis sini-->
							</div>
							<div class="clearfix"></div>
							</div>
								...
								<div class="contain">	
								 ...
								 <!-- Form -->
									<form action="" method="POST"  enctype="multipart/form-data">
										...
										<div>
											<label class="col-sm-4 control-label"><font color="black">Date Of Birth :</font></label>
												<div class="col-sm-6">
												<input placeholder="" type="date" name="dob" tabindex="4" >
											</div>
										</div>
											
										<div>
											<label>
												<input placeholder="Department :" name="department" type="text" tabindex="3" >
											</label>
										</div>
										<div>
											<label>
												<input placeholder="Phone Number:" name="phone" type="text" tabindex="3" >
											</label>
										</div>
										<div class="sky-form">
											<div class="sky_form1">
												<label class="col-sm-2 control-label"><font color="black">Gender :</font></label>
												<ul>
										...
										<div class="form-group">
											<label for="exampleInputFile">Timetable</label>
											<input type="file"  name="file">
											<p class="help-block">Upload the lecturer's timetable here.</p>
										 </div>
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="admin.php"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Registration</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="register_lecturer.php">Add Lecturer</a></li>
										   <li id="menu-academico-avaliacoes" ><a href="register_student.php">Add Student</a></li>
										  </ul>
										</li>
									...
									<li id="menu-academico" ><a href="#"><i class="lnr lnr-pencil"></i> <span>Manage User</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										 <ul id="menu-academico-sub" >
											...
											<li id="menu-academico-boletim" ><a href="delUser.php">Delete User</a></li>
										  </ul>
									</li>
								  </ul>
								</div>
