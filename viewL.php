							...
							<div class="panel-title">
							 ...
							 <table border ="1px" width="100%">
								        ...
								        <?php
								            ...
								            $query = mysql_query ("Select lect_id , name , username from lecturer");
								            while($row = mysql_fetch_array($query))
								            {
								            Print "<tr>";
								              Print '<td align="center">'. $row['lect_id']. "</td>";
								              Print '<td align="center">'. $row['name']. "</td>";
								              Print '<td align="center">'. $row['username']. "</td>";
								              Print '<td align="center"><a href="#!" onclick="myFunction_1('.$row['lect_id'].')">Update</a></td>';
								              Print '<td align="center"><a href="#!" onclick="myFunction_2('.$row['lect_id'].')">Delete</a></td>';
								            Print "</tr>";
								            }
								        ?>
								    	</table>
								    ...
								    <script>
								    		...
								    		{
								    			var r=confirm("Updating the lecturer ?");
								    			if (r=true)
								    			{
								    				location.href="updL.php?lect_id=" + id;
								    			}
								    		}
								    		function myFunction_2(id)
								    		{
								    			var r=confirm("Deleting the lecturer ?");
								    			if (r=true)
								    			{
								    				location.href="delL.php?lect_id=" + id;
								    			}
								    		}
								    	</script>
							</div>
