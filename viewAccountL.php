...
{
	$sql ="Select * from lecturer where username ='{$s}'";
					...
					<div class="monthly-grid">
						<div class="panel panel-widget">
							<div class="panel-title">
							  ...
							  <br>
							  <br>
							  	<div class="contain" class="col-sm-12" >

										<form action="" method="POST" name="form2" id="form2">
										<div>
											<label class="col-sm-2 control-label"><font color="black">Name :</font></label>
												<div class="col-sm-4">
												<?php echo $row['name'];?>
											</div>
											</label>
										...
										<div>
											<label class="col-sm-2 control-label"><font color="black">Username :</font></label>
												<div class="col-sm-4">
										...
										<div>
											<label class="col-sm-2 control-label"><font color="black">Password :</font></label>
												<div class="col-sm-4">
										...
										<br>
										<div>
											<label class="col-sm-2 control-label"><font color="black">Department :</font></label>
												<div class="col-sm-4">
										...
										<div>
											<label class="col-sm-2 control-label"><font color="black">Phone Number :</font></label>
												<div class="col-sm-4">
												<?php echo $row['phone'];?>
												</div>
											</label>
										...
										<center>
										<div class="col-sm-12">
											<label class="col-sm-2 control-label"><font color="black">Timetable :</font></label>
												<div class="col-sm-4">
												<?php
