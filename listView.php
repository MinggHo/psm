...
$condition = "";
if($_POST){
	$condition = $condition . " AND department LIKE '%" . $_POST['department'] . "%' AND username LIKE '%" . $_POST['term'] . "%' OR name LIKE '%" . $_POST['term'] . "%'";
}

$query = "SELECT * from lecturer " . $condition ;
		...
		<!-- header-starts -->
			...
			<div class="content">
					<div class="monthly-grid">
						<div class="panel panel-widget">
							<div class="panel-title">
							  Student Page - Search Lecturer by Name
							  
							  <div class="row">
								<form action="listView.php" method="post">
									<div class = "col-md-6">
                                        <h4>Search :</h4>
                                            <input type="text" name = "term" class="form-control"><select name="department" required="required">
                    ...
                    ?>
                                         ...
                                         <input type="submit" class="btn btn-primary" value="View Lect Timetable"/>	
										 <input type="submit" class="btn btn-primary" value="View Lect Status"/>
